...
import { SorteoPattern} from '../types';
import Spinner from './Spinner';

interface SorteoPatternFormProps {
  onSubmit: (SorteoPattern: Omit<SorteoPattern, 'id'>) => void;
  initialData?: SorteoPattern;
  onCancel: () => void;
}

export default function SorteoPatternForm({ onSubmit, initialData, onCancel }: SorteoPatternFormProps) {
